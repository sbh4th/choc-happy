...
t2c <- lm_robust(y ~ treated + period, data=d, clusters=id)
t2i <- lm_robust(y ~ treated * period, data=d, clusters=id)
out <- summary(t2i)
...
```{r figure1, echo=F, fig.cap="Predicted happiness index from interaction model"}
